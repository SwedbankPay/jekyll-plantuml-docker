...
describe Jekyll::PlantUml::GemfileDiffer do
  ...
  describe "#diff" do
    ...
    context "two existing files" do
      specify { expect { |line| differ.diff(primary_gemfile_path, secondary_gemfile_path, &line) }.to yield_control.exactly(11).times }
      specify { expect { |line| differ.diff(primary_gemfile_path, secondary_gemfile_path, &line) }.to yield_successive_args("gem \"jekyll\", \"~> 4.1\", group: :jekyll_plugins\n", "gem \"jekyll-assets\"\n", "gem \"jemoji\"\n", "gem \"faraday\", \"~> 1.0.1\"\n", "gem \"jekyll-material-icon-tag\"\n", "gem \"kramdown-plantuml\"\n", "gem \"jekyll-github-metadata\"\n", "gem \"docopt\"\n", "gem \"html-proofer\"\n", "gem \"html-proofer-unrendered-markdown\"\n", "gem \"rouge\"\n") }
    end
  end
end
